...
class AssetsTestCase(CourseTestCase):
    def setUp(self):
        ...
        self.url = self.location.url_reverse('assets/', '')
...
class AssetsToyCourseTestCase(CourseTestCase):
    ...
    def test_toy_assets(self):
        ...
        _, course_items = import_from_xml(module_store, 'common/test/data/', ['toy'], static_content_store=contentstore(), verbose=True)
...
class LockAssetTestCase(CourseTestCase):
    ...
    def test_locking(self):
        ...
        def post_asset_update(lock):
            ...
            resp = self.client.post(url, json.dumps(assets._get_asset_json("sample_static.txt", upload_date, asset_location, None, lock)), "application/json")
